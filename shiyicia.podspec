...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/xiaochengshaoye/LMJFirstRepo"
  ...
  s.source       = { :git => "https://github.com/xiaochengshaoye/LMJFirstRepo.git", :tag => s.version.to_s }
  ...
  s.source_files  = "shiyicia/shiyicia/**/*.{h,m}"
